...
const SoilAI = () => {
  ...
  return (
    <div className="min-h-screen bg-green-100   mt- flex flex-col gap-7 items-center justify-center ">
      ...
      {result && (
        <section className="w-full max-w-7xl mt-16 px-4">
          ...
          <p className="text-center text-gray-500 mt-2 mb-10">
            Comprehensive analysis of nitrogen, phosphorus, and potassium levels
            with AI-powered predictions for optimal crop growth.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl shadow p-6 flex flex-col items-center justify-center">
              ...
              <div className="relative w-36 h-36 flex items-center justify-center">
                <svg className="absolute w-full h-full rotate-[-90deg]">
                  ...
                  <circle
                    ...
                    strokeDasharray="377"
                    strokeDashoffset={
                      377 - (377 * result.soilHealthScore) / 100
                    }
                  />
                </svg>
              ...
              <p className="text-xs text-center text-gray-500 mt-3">
                Your soil is in good condition. Minor improvements in phosphorus
                levels can boost overall health.
              </p>
            </div>
            ...
            <div className="lg:col-span-2 bg-white rounded-xl shadow p-6">
              ...
              {[
                {
                  name: "Nitrogen (N)",
                  value: result.npkLevels.nitrogen,
                  max: 100,
                },
                {
                  name: "Phosphorus (P)",
                  value: result.npkLevels.phosphorus,
                  max: 100,
                },
                {
                  name: "Potassium (K)",
                  value: result.npkLevels.potassium,
                  max: 150,
                },
              ].map((item, i) => (
            ...
            <div className="bg-green-100 rounded-xl shadow p-6">
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
                ...
                <p className="text-sm">
                  Impact: {result.soilDeficiencyPredictor.impact}
                </p>
                <p className="text-sm">
                  Recommendation:{" "}
                  {result.soilDeficiencyPredictor.recommendation}
                </p>
            ...
            <div className="lg:col-span-2 bg-white rounded-xl shadow p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                {result.recommendedCrops.map((crop, i) => (
                  <div key={i} className="bg-green-50 p-4 rounded-xl shadow-sm">
